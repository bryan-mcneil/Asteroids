...
#     Bryan McNeil
# Summary:
#     Ship: ship has top speed of 10 (vel on X and Y)
#       when not thrusting the ship will gradually slow down.
#       ship will wrap with the screen
#     Bullets: On fire the bullets will add the ship's velocity.
#       Bullets wrap with screen and die after 40 frames.
#     Collision: Ship and Asteroids collide and bullets kill Asteroids 
# Above and Beyond
#     Level: There is a level system, once all Asteroids are destoryed
#       it goes to next level with more Asteroids. 
#     Delay: There is a 60 frame delay into between sets of Asteroids.
#     Death: When the Ship crash it has a visual death effect.
#     Ship slows down easier to control. 
###############################################################
